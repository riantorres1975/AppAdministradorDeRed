...
public class HomepageController implements Initializable {
    ...
    private void search_dispo(ActionEvent ev) throws IOException {
        ...
        Parent raiz = FXMLLoader.load(getClass().getResource("/LocalizarDispositivos/LocalizarDispositivosFXML.fxml"));
    ...
    private void ir_ajustes(ActionEvent event) throws IOException {
        Stage primaryStage = new Stage();
        Parent raiz = FXMLLoader.load(getClass().getResource("/configuracion/configuracion.fxml"));
        Scene escena = new Scene(raiz);
    ...
    private void registro_fallas(ActionEvent event) throws IOException {
        Stage primaryStage = new Stage();
        Parent raiz = FXMLLoader.load(getClass().getResource("/Registro_Falla/Registro.fxml"));
        Scene escena = new Scene(raiz);
